...
function Clave() {
    ...
    const handleOnCreateUser = async (event) => {
        if (VALIDATIONS.PASSWORD(password) && VALIDATIONS.PASSWORD(confirmPassword) && VALIDATIONS.PASSWORD(password) && password === confirmPassword && VALIDATIONS.REQUIRED_FREE_TEXT(query.oobCode)) {
            ...
            toast.error("Tus contraseñas no coinciden o tu código de seguridad no es correcto, por favor corregir.")
        }
                ...
                <div className="p-10 ">
                    <div className="box-content h-full w-100 p-4  rounded-md ">
                        <div className="box-content text-left font-bold ">
                            <p className=" text-purple-600 self-start   text-3xl">Crear nueva contraseña</p>
                        </div>
