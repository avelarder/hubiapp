...
import { getScheduleYears, getScheduleMonths, getScheduleDays } from '../../utils/UI-Constants';
            ...
            <section className=''>
                ...
                <FieldContainer title={"Fecha de Nacimiento"}>
                    <div className="flex flex-wrap m-1">
                        <div className="flex flex-col w-40 m-1">
                            <Select
                                title={"Mes"}
                                showTitle={true}
                                options={months}
                        ...
                        <div className="flex flex-col w-24 m-1">
                            <Select
                                title={"Día"}
                                showTitle={true}
                                options={days}
