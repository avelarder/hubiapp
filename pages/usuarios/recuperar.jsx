...
export default function Recuperar() {
  ...
  const handleOnConfirm = () => {
    ...
    toast.success(
      "Exito, le hemos enviado un correo para restablecer su contraseña."
    );
        ...
        <div className="p-10 ">
          <div className="box-content flex flex-col h-full w-100 p-4  rounded-md ">
            ...
            <p className="flex  mt-4 text-center ">
              Te enviaremos un correo con un código de activación que estará
              activo por 30 minutos.
            </p>
            <p className="flex  text-center">
              Escribe el correo electrónico asociado a tu cuenta HUBI.
            </p>
