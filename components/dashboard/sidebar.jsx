  ...
  return (
    <div className="lg:w-28">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-28 flex-shrink-0 bg-white p-4 transition-transform duration-200 ease-in-out ${
      ...
      >
        ...
        <div>
          <ul className="mt-3 items-center ">
            ...
            <SidebarItem
              icon={
                <IdentificationIcon className="text-white"></IdentificationIcon>
              }
              backgroundColor="bg-hubi_light_blue"
              path="/app/residentes"
              text="Residentes"
            ...
            <SidebarItem
              icon={
                <ClipboardListIcon className="text-white"></ClipboardListIcon>
              }
              backgroundColor="bg-purple-400"
              path="/app/informes"
              text="Informes"
