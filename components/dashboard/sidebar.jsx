  ...
  return (
    <div className="lg:w-20">
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-20 flex-shrink-0 bg-gray-100 p-4 transition-transform duration-200 ease-in-out ${
      ...
      >
        ...
        <div className="flex justify-center mb-10 pr-3 sm:px-2">
          ...
          <NavLink exact href="/" className="block">
            <div className="relative flex align-middle items-center justify-center my-4 bg-gray-900">
              <svg
                className="absolute flex text-purple-400 "
                width="22"
                height="22"
                viewBox="0 0 18 18"
                fill="none"
        ...
        <div>
          <ul className="mt-3 items-center ">
            {/* Dashboard */}
            <SidebarItem
              icon={<HomeIcon className="text-purple-600"></HomeIcon>}
              path="/app/dashboard"
              text="Inicio"
            ></SidebarItem>
            <SidebarItem
            ...
            <SidebarItem
              icon={
                <ShieldCheckIcon className="text-purple-600"></ShieldCheckIcon>
              }
            ...
            <SidebarItem
              icon={
                <IdentificationIcon className="text-purple-600"></IdentificationIcon>
              }
              path="/app/residentes"
              text="Residentes"
            ></SidebarItem>
            <SidebarItem
              icon={<UserGroupIcon className="text-purple-600"></UserGroupIcon>}
            ...
            <SidebarItem
              icon={<CogIcon className="text-purple-600"></CogIcon>}
